...
<html dir="ltr" lang="en">
    <head>
        ...
        <title>Administration | @yield('page_title', 'Soundcore Records')</title>
    ...
    <body>
        ...
        <div id="main-wrapper">
            @include('templates._topbar')

            @include('templates._left-sidebar')
            ...
            <div class="page-wrapper">
                ...
                <!-- footer -->
                <footer class="footer text-center">Soundcore Records 2019</footer>
                <!-- /footer -->
        ...
        <script src="/admin/js/pages/chart/chart-page-init.js"></script>
