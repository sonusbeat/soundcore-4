...
class SinglesRequest extends FormRequest
{
    ...
    public function rules(Route $route)
    {
        ...
        return [
            ...
            'catalog'   => 'required|between:3,150unique:singles,catalog,'.$id,
            'upc'       => 'required|between:3,255unique:singles,upc,'.$id,
            'isrc'      => 'required|between:3,255unique:singles,isrc,'.$id,
            'released_at'  => 'required|date',
            'description'  => 'required|min:8',
            'coverart'     => 'nullable|between:3,200',
